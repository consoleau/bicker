describe('WatchableListFactory', function() {
  beforeEach(function() {
    window.angular.mock.module('bicker_router');
  });

  it('notifies watchers of changes to data', inject(function(WatchableListFactory) {
    const watchableList = WatchableListFactory.create();
    const watcher = jasmine.createSpy();
  ...
  it('notifies watchers when a value is unset', inject(function(WatchableListFactory) {
    const watchableList = WatchableListFactory.create();
    const watcher = jasmine.createSpy();
  ...
  it('notifies watchers when an array of values are unset', inject(function(WatchableListFactory) {
    const watchableList = WatchableListFactory.create();
    const watcher = jasmine.createSpy();
  ...
  it('notifies watchers when descendant values change', inject(function(WatchableListFactory) {
    const watchableList = WatchableListFactory.create();
    const watcher = jasmine.createSpy();
    ...
    const lastCall = watcher.calls.mostRecent();
  ...
  describe('getAll', function() {
    it('returns all data', inject(function(WatchableListFactory) {
      const watchableList = WatchableListFactory.create();
      watchableList.set('a.b', 'z');
  ...
  describe('getSubset', function() {
    it('returns an object with all the requested values', inject(function (WatchableListFactory) {
      const watchableList = WatchableListFactory.create();
